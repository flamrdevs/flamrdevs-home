...
const Root = recipe({
	base: {
		...
		selectors: {
			...
			"&[data-disabled]": {
				pointerEvents: "none",
				backgroundImage: `linear-gradient(140deg, ${vars.v_color_2}, ${vars.v_color_1})`,
				color: vars.v_color_8,
			},

			"&[data-disabled]::before": {
				backgroundImage: `linear-gradient(140deg, ${vars.v_color_5}, ${vars.v_color_4}, ${vars.v_color_3})`,
			},
		},
	},
